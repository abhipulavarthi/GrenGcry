...
var t3 = class L {
  ...
  stateMachineStart() {
    ...
    if (this._stateMachineConfig) {
      ...
      if (u && typeof u.requireUserInteraction == "boolean" && (i.requireUserInteraction = u.requireUserInteraction), u == null ? void 0 : u.whitelist) {
...
var m2 = class h1 {
  constructor(i) {
    ...
    this._worker = h1._workerManager.getWorker(n), h1._workerManager.assignAnimationToWorker(this._id, n), h1._wasmUrl && this._sendMessage("setWasmUrl", { url: h1._wasmUrl }), this._create({ ...i, renderConfig: { ...i.renderConfig, devicePixelRatio: ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || u1(), freezeOnOffscreen: ((_b = i.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } }), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this));
  }
  ...
  async _create(i) {
    ...
    let { instanceId: u } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: n }, ...q2(this._canvas, ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || u1()) }, [n]);
...
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: u, createDotLottie: _, data: y, dotLottieRefCallback: c, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: d1, segment: D, speed: c1, src: q, stateMachineConfig: i1, stateMachineId: K, style: l1, themeData: _1, themeId: z, useFrameInterpolation: O, workerId: n1, ...Z }) => {
  ...
  let A1 = (0, import_react.useCallback)((x) => {
    var _a, _b;
    C.current = x, x ? w.current = _({ ...r1.current, canvas: x }) : ((_a = w.current) == null ? void 0 : _a.destroy(), w.current = null), (_b = g1.current) == null ? void 0 : _b.call(g1, w.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let x = (w1) => {
      var _a2, _b2;
      m1 && (w1.type === "mouseenter" && ((_a2 = w.current) == null ? void 0 : _a2.play()), w1.type === "mouseleave" && ((_b2 = w.current) == null ? void 0 : _b2.pause()));
    };
    ...
    var _a;
    (_a = w.current) == null ? void 0 : _a.setSpeed(c1 ?? 1);
    ...
    var _a;
    (_a = w.current) == null ? void 0 : _a.setRenderConfig(d1 ?? {});
  }, [JSON.stringify(d1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof y != "string" && typeof y != "object" || ((_a = w.current) == null ? void 0 : _a.load({ data: y, ...r1.current }));
  }, [y]), (0, import_react.useEffect)(() => {
    var _a;
    typeof q == "string" && ((_a = w.current) == null ? void 0 : _a.load({ src: q, ...r1.current }));
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.loadAnimation(h ?? "");
  }, [h]), (0, import_react.useEffect)(() => {
    var _a;
    typeof z == "string" && ((_a = w.current) == null ? void 0 : _a.setTheme(z));
  }, [z]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = w.current) == null ? void 0 : _a.setThemeData(_1 ?? "");
